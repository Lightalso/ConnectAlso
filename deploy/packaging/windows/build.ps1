# =============================================================================
# Script: build.ps1
# Purpose: Builds ConnectAlso Windows binaries and packages them as an MSI
#          installer and a portable ZIP archive
# 用途: 构建 ConnectAlso Windows 二进制文件，并打包为 MSI 安装程序和便携 ZIP 压缩包
#
# Prerequisites / 前置要求:
...
#
# Usage / 用法: powershell -File deploy\packaging\windows\build.ps1 -Version "0.1.0"
# =============================================================================
...
# 1. Build Rust binaries / 构建 Rust 二进制文件
...
# Wintun driver note / Wintun 驱动说明
@"
Wintun Driver
=============
...
# 3. Sign binaries (if certificate provided) / 签名二进制文件（如提供证书）
...
# 4. Create MSI installer with WiX / 使用 WiX 创建 MSI 安装程序
...
# 5. Create portable ZIP / 创建便携 ZIP 压缩包
